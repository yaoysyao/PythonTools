...
test_looger = getLogger(log_name='test', save_log2_file=True, log_path='../../demo/log', is_only_file=False, log_level=MY_LOG_ALL, is_split_log=False, is_all_file=False, log_file_name='test')
